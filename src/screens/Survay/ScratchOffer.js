import { View, Text, TouchableOpacity,Image,StyleSheet,Dimensions,Clipboard,ToastAndroid } from 'react-native'
           ...
           <TapGestureHandler numberOfTaps={2} onActivated={() => handleRemoveScratch()}>
              <View>
                <View style={styles.ScratchBottomOffer} >
                  ...
                  <Image source={amazon}  style={{marginTop:60}}/>
                  ...
                  {removeScratch ? <Image source={scratchCard} style={styles.ScratchTopImage}/> : <Text></Text>}
              </View>
             </TapGestureHandler>
           </View>
           <BottomSheetModal
              ...
              backgroundStyle={{ borderRadius: 30,zIndex:2 }}
           >
            <BottomSheetScrollView>
