import { View, Text, TouchableOpacity,Image,StyleSheet,Dimensions,Clipboard,ToastAndroid,ImageBackground } from 'react-native'
...
const ScratchOffer = ({setShowOffer}) => {
  ...
  return (
        <View style={styles.container}>
           ...
           <TapGestureHandler numberOfTaps={2} onActivated={() => handleRemoveScratch()}>
              <View>
                ...
                <Image source={tankyouCelebration} style={styles.tankyouCelebration} />
                  ...
                  <Image source={amazon}  style={{marginTop:30,width:80,height:30}}/>
            ...
            <ScrollView>
              {removeScratch ?
                <View style={styles.SheetContentContainer}>
                    ...
                    <Text style={styles.beforeCratchText}>Scratch the card to win exciting gifts </Text>
                </View>
               :
               <View style={styles.SheetContentContainer}>
