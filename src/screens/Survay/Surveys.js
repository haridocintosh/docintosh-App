    ...
    >
      <View style={{padding:10}}>
        <View style={{marginTop:10}}>
          <Card style={styles.CartStyle} onPress={()=>{ navigation.navigate('SurveyMcq') }} >

            <View style={styles.ExpiringContainer}>
              <View style={styles.incompletebg}>
                <Text style={styles.completeText}>Incomplete</Text>
              </View>
              <View style={styles.ExpiringContainer}>
                <MaterialCommunityIcons name="clock-time-five-outline" size={20} color="red" />
                <Text style={styles.ExpiringText}> Expairing on 27 August</Text>
              </View>
            </View>

             <Text style={styles.survatTitle}>Bombay Survey - Allergies Survey for Doctor</Text>
...
const styles = StyleSheet.create({
  ...
  ExpiringText:{color:'red',alignItems:'center',justifyContent:'center',fontSize:12},
