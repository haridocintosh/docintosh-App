...
// console.log('1111',allPost);
  ...
  const loadMore = () => {
    ...
    const renderItem = ({item}) => {
      return(
        <Card style={{marginTop:20, borderRadius:10,shadowRadius:10, padding:15}} >
              ...
              <Image source={profileimg} onPress={() => navigation.navigate('ProfileScreen2')} style={{width:38, height:38,marginRight:5}} ></Image>
                <View >
                  ...
                  <View style={{flexDirection:'row',alignItems:'center'}}>
                      ...
                      <Text style={{fontSize:12, paddingRight:5, fontWeight:'400',color:'#51668A'}}>{item.post_date} 1hr ago</Text>
                  </View>
                </View> 
            </View>
            <View>
          ...
          <View style={{ flex: 1, flexDirection: 'row',marginTop:10}}>
              <View style={{ flexDirection: 'row',marginVertical:5  }}>
                <View style={{paddingRight:5, flexDirection:'row'}}>
                  ...
                  <Text style={{paddingLeft:10,color:'#51668A'}}>{item.likecount}k</Text>
                </View>
                ...
                <View style={{paddingLeft:20, flexDirection:'row'}}>
                  ...
                  <Text style={{paddingLeft:10,color:'#51668A'}}>{item.commentcount}K</Text>
                </View>
