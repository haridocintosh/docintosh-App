...
import {
  ...
  ScrollView,
  StyleSheet,
  Image,TouchableOpacity,Linking,ProgressBarAndroid
} from 'react-native';
...
import vectortop from '../assets/dr-icon/Vector.png';
...
// like unlike fun=>
  ...
  <SafeAreaView>
   ...
   <Card style={{marginTop:-35, zIndex:1, borderRadius:50,shadowRadius:10, shadowOffset:10}} onPress={() => navigation.navigate('SharePost')}>
    ...
    <Image source={p2} style={{width:32, height:32}}></Image>
...
<Card style={{marginTop:20, borderRadius:10,shadowRadius:10,}}>
  ...
  <View>
    <Image source={grid6} style={{width:350,height:200, alignSelf:'center'}}/>
...
<FontAwesome5 name="users" size={13} color="#45B5C0" /> 
  ...
  <View>
    <Image source={drban} style={{width:350,height:200, alignSelf:'center'}}/>
