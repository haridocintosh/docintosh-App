...
<View style={{zIndex:1, marginBottom:-35}}>
  ...
  <AntDesign name="rightcircle" size={24} color="#2C8892"  onPress={() => navigation.navigate('Survey1')} />
  </View>
  <View style={{margin:10}}></View>
  <View style={{paddingLeft:20}}>
  <AntDesign name="leftcircle" size={24} color="#2C8892" onPress={() => navigation.navigate('Survey1')} />
  </View>
  ...
  <Text style={{marginTop:10, fontSize:16, fontWeight:'600', color:'#071B36',lineHeight:24}}>What happens when a clot occurs in an undamaged blood vessel?</Text>
