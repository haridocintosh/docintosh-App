...
export const survayList = createAsyncThunk("getSurveyList", async (data)=>{
    ...
    try{
        const responce = await fetch(`${mainApi.baseUrl}/ApiController/getSurveyList`, {
            method : 'POST',
            headers:{
...
export const getSurveyQuestions = createAsyncThunk("getSurveyQuestions", async (data)=>{
    //  console.log("survayListDataaaa",data);
    try{
        const responce = await fetch(`${mainApi.baseUrl}/ApiController/getSurveyQuestions`, {
            method : 'POST',
            headers:{
                'Content-Type': 'application/json'
            },
